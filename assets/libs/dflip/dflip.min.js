        ...
        ((t =
          ...
          (this.to = function (e, t) {
            ...
            (this.update = function (t) {
              if (t < c) return !0;
              for (h in (!1 === m && (null != v && v.call(e), (m = !0)),
              (w = (w = (t - c) / s) > 1 ? 1 : w),
              (P = d(w)),
              o))
                if (null != i[h]) {
            ...
            Bezier: function (e, i) {
              for (
                var n = 0,
                  o = e.length - 1,
                  a = Math.pow,
                  s = t.Interpolation.Utils.Bernstein,
                  r = 0;
                r <= o;
                r++
              )
    ...
    (function () {
      ...
      var a = n.jQuery,
        ...
        l = (n.utils = {
          ...
          getSharePrefixes: function () {
            return (
              n.defaults.sharePrefix + ",dflip-,flipbook-,dearflip-,dearpdf-"
            )
              .split(",")
              .map(function (e) {
                return e.trim();
          ...
          angleByDistance: function (e, t) {
            var i = t / 2,
              n = l.limitAt(e, 0, t);
            return n < i
              ? l.toDeg(Math.asin(n / i))
              : 90 + l.toDeg(Math.asin((n - i) / i));
          },
          ...
          detectScriptLocation: function () {
            if (void 0 === window[n.locationVar])
              a("script").each(function () {
                var e = a(this)[0].src;
                if (
                  (e.indexOf("/" + n.locationFile + ".js") > -1 ||
                    e.indexOf("/" + n.locationFile + ".min.js") > -1 ||
                    e.indexOf("js/" + n.locationFile + ".") > -1) &&
            ...
            void 0 !== window[n.locationVar] &&
              window[n.locationVar].length > 2 &&
              "/" !== window[n.locationVar].slice(-1) &&
              (window.window[n.locationVar] += "/");
          },
                ...
                if (i.length > 0) {
                  ...
                  if (
                    ...
                    (o = a(o[0])),
                      ...
                      l.focusHash(o);
                    var r =
                      (n.activeLightBox && n.activeLightBox.app) ||
                      o.data("df-app");
                    if (null != r)
                      return (
                        r.gotoPage(s),
      ...
      (l.getOptions = function (e) {
        ...
        (l.sanitizeOptions = function (e) {
          var t, i;
          if (
            ((e.showDownloadControl = l.parseBoolIfExists(
            ...
            (e.flipbook3DTiltAngleLeft = l.parseIntIfExists(
              e.flipbook3DTiltAngleLeft
            )),
            (e.flipbook3DTiltAngleUp = l.parseIntIfExists(
            ...
            void 0 !== e.loadMoreCount &&
              ((e.loadMoreCount = l.parseInt(e.loadMoreCount)),
          ...
          for (
            ...
            1 == (a.match(/@/g) || []).length
              ? a.match(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,7})+/gi) &&
                o.push({ index: t.index, length: a.length, text: a })
              : a.match(
          ...
          return e.replace(
            ...
            function (e, t, i, n, o) {
              ...
              if (
                ...
                return l.log("AutoLink Rejected: " + a + " for " + e), e;
      ...
      (n.parseCSSElements = function () {
        ...
        (n.parseThumbs = function (e) {
          ...
          s.attr("data-src", e.thumbURL),
            ...
            !0 === n.defaults.displayLightboxPlayIcon &&
          ...
          a(".df-posts").each(function () {
            if (
              ...
              if ("true" !== e.data("df-parsed")) {
                ...
                var t = 0,
                  ...
                  o = i.length;
                i.each(function () {
                  ++t > n.defaults.loadMoreCount &&
                    a(this).attr("skip-parse", "true");
                }),
                  o > n.defaults.loadMoreCount &&
                    e.append(
            ...
            a(".df-element").each(function () {
              ...
              if (
                ...
                if (void 0 === t)
                  e.addClass("df-lazy-embed"), n.addLazyElement(e[0]);
                  ...
                  "button" === t &&
                    n.defaults.buttonClass &&
                    e.addClass(n.defaults.buttonClass);
            ...
            (n.handleLazy = function () {
              var e;
              if (
                n.removeEmbeds.length > n.removeEmbedsLimit &&
                (e = n.removeEmbeds.shift())
              ) {
                var t = a("[initID='" + e + "']");
                if (t.length > 0) {
                  var i = t.data("df-app");
        ...
        "function" == typeof IntersectionObserver &&
          (n.lazyObserver = new IntersectionObserver(function (e, t) {
            e.forEach(function (e) {
              ...
              e.isIntersecting
                ? (!i.attr("initID") &&
                    (i.attr("initID", n.initId),
                    (o = n.initId.toString()),
                    n.initId++),
                  (t = n.removeEmbeds.indexOf(o)) > -1
                    ? (n.removeEmbeds.splice(t, 1),
                      l.log("Removed id " + o + "from Removal list"))
                    : -1 == (t = n.embeds.indexOf(o)) &&
                      (n.embeds.push(o),
                      l.log("Added id " + o + "to Add list")))
                : o &&
                  ((t = n.embeds.indexOf(o)) > -1
                    ? (n.embeds.splice(t, 1),
                      l.log("Removed id " + o + " from Add list"))
                    : -1 == (t = n.removeEmbeds.indexOf(o)) &&
                      (n.removeEmbeds.push(o),
                      l.log("Added id " + o + " to Removal list"))),
                (d = 0),
                (n.removeEmbeds.length > n.removeEmbedsLimit ||
                  n.embeds.length > 0) &&
                  null == n.checkRequestQueue &&
                  ((n.checkRequestQueue = function () {
                    d++,
                      n.checkRequestQueue &&
      ...
      (n.addLazyElement = function (e) {
        ...
        (n.parseElements = l.parseElements =
          function () {
            ...
            e.on("click", ".df-posts .df-load-more-button", function () {
              ...
              if (e.length > 0) {
                ...
                e.find(".df-element").each(function () {
                  var e = a(this);
                  "true" === e.attr("skip-parse") &&
                    (t < n.defaults.loadMoreCount && e.removeAttr("skip-parse"),
                    t++);
                }),
                  n.parseNormalElements();
              }
            }),
            n.defaults.shelfImage &&
              "" != n.defaults.shelfImage &&
              e.append(
              ...
              },
              {
                ...
                value: function (e) {
                  null != e.touches &&
                    ...
                    ((this.startTouches = f.getTouches(e)),
                    (this.app.viewer.zoomCenter = f.getVectorAvg(
                      f.getTouches(e, this.parentElement.offset())
                    )),
                    (this.lastScale = 1));
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    ...
                    var t = f.calculateScale(
                      this.startTouches,
                      f.getTouches(e)
                    );
                    this.lastScale,
                      (this.lastScale = t),
                      (this.app.viewer.pinchZoomUpdateScale = f.limitAt(
                        t,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.app.refreshRequestStatus =
                    !0 === e ? n.REQUEST_STATUS.ON : n.REQUEST_STATUS.OFF;
                },
              },
              {
                key: "getPageByNumber",
          ...
          var t,
            ...
            o =
              ...
              function () {
                ...
                return (
                  (e = t
                    ? Reflect.construct(i, arguments, T(this).constructor)
                    : i.apply(this, arguments)),
                  e &&
                  ("object" ==
                    (e &&
          ...
          return (
            (i = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new S({ parentElement: this.wrapper });
                ...
                value: function () {
                  ...
                  var e =
                    ...
                    i =
                      ...
                      20 -
                      this.app.dimensions.padding.width;
                  this.app.pageScaling === n.PAGE_SCALE.ACTUAL &&
                    (i = 1 * this.app.provider.defaultPage.viewPort.width);
                  var o = e;
                  return (
                    this.app.pageScaling === n.PAGE_SCALE.PAGE_WIDTH
                      ? (o = 100 * t.height)
                      : this.app.pageScaling === n.PAGE_SCALE.AUTO
                      ? (o = 1.5 * t.height)
                      : this.app.pageScaling === n.PAGE_SCALE.ACTUAL &&
                        (o = 1 * t.height),
                    (o -= 2),
                ...
                value: function () {
                  ...
                  for (
                    var n = this.getVisiblePages().main[0] - 1,
                      ...
                      a = this.parentElement[0].getBoundingClientRect(),
                      s = 0;
                    s < this.pages.length;
                    s++
                  ) {
                  ...
                  if (
                    ...
                    var c =
                        n.offsetTop +
                        n.clientTop -
                        (o.top - a.top + n.clientTop) * p,
                      d =
                        n.offsetLeft +
                        n.clientLeft -
                        (o.left - a.left + n.clientLeft) * p;
                    (c += ((p - 1) * 10) / 2),
                      (d += ((p - 1) * 10) / 2),
                      (this.zoomCenter =
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.scrollStatus === n.REQUEST_STATUS.ON ||
              ...
              },
              {
                ...
                value: function () {
                  x(T(a.prototype), "checkRequestQueue", this).call(this),
                    this.scrollStatus === n.REQUEST_STATUS.ON &&
                      (this.scrollStatus = n.REQUEST_STATUS.OFF),
                    this.scrollStatus === n.REQUEST_STATUS.COUNT &&
                      (this.scrollStatus = n.REQUEST_STATUS.ON);
                },
              },
              ...
              { key: "validatePageChange", value: function (e) {} },
              {
                ...
                value: function () {
                  if (!0 !== this.skipScrollIntoView) {
                    ...
                    null != e &&
                      E.scrollIntoView(e.element[0], this.element[0]);
                  }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (e.touches && e.touches.length < 2) ||
                    x(T(a.prototype), "mouseMove", this).call(this, e);
                },
              },
              {
                key: "mouseDown",
      ...
      function D(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, _(this).constructor)
        ...
        z = /*#__PURE__*/ (function (e) {
          ...
          function i(e, o) {
            ...
            return (
              ...
              (a.maxZoom = 4),
              (a.pureMaxZoom = 4),
              (a.app.options.pageSize === n.FLIPBOOK_PAGE_SIZE.AUTO ||
                a.app.options.pageSize ===
                  n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL) &&
            ...
            N(i, [
              {
                ...
                value: function () {
                  ...
                  var e = this.app;
                  (this.pageMode =
                    e.options.pageMode === n.FLIPBOOK_PAGE_MODE.AUTO
                      ? F.isMobile || e.pageCount <= 2
                        ? n.FLIPBOOK_PAGE_MODE.SINGLE
                        : n.FLIPBOOK_PAGE_MODE.DOUBLE
                      : e.options.pageMode),
                    (this.singlePageMode =
                      e.options.singlePageMode ||
                      (F.isMobile
                        ? n.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET
                        : n.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM)),
                    this.updatePageMode(),
              ...
              { key: "determineHeight", value: function () {} },
              {
                ...
                value: function () {
                  ...
                  var e = this,
                    ...
                    a = t.options.text,
                    s = t.options.icons;
                  (o.sound = F.createBtn("sound", s.sound, a.toggleSound).on(
                    "click",
                    function () {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.app.pageCount < 3)
                    ...
                    this.app.options.pageMode === n.FLIPBOOK_PAGE_MODE.AUTO &&
                ...
                value: function () {
                  (this.soundFile = document.createElement("audio")),
                    this.soundFile.setAttribute(
                      "src",
                      this.app.options.soundFile + "?ver=" + n.version
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.pageSize === n.FLIPBOOK_PAGE_SIZE.AUTO &&
                    (e._page2Ratio &&
                    e._page2Ratio > 1.5 * e.defaultPage.pageRatio
                      ? (e.pageSize = n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL)
                      : (e.pageSize = n.FLIPBOOK_PAGE_SIZE.SINGLE)),
                    e.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL &&
                      (e.pageCount = 1 === e.numPages ? 1 : 2 * e.numPages - 2),
                    (e.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK ||
                      e.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE) &&
                ...
                value: function (e) {
                  return (
                    this.app.provider.pageSize ===
                      ...
                      (e = 2 * e - 1),
                    this.app.provider.pageSize ===
                      n.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK &&
                      e > 2 &&
                      (e = 2 * e - 1),
                    e
                  );
              ...
              },
              {
                ...
                value: function (e) {
                  return this.app.provider.pageSize ===
                    n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL && e > 2
                    ? Math.ceil((e - 1) / 2) + 1
                    : this.app.provider.pageSize ===
                        n.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK && e > 1
                    ? e === this.app.pageCount
                      ? 1
                      : Math.ceil((e - 1) / 2) + 1
                    : e;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return this.filterViewPort(
                    I(_(i.prototype), "getViewPort", this).call(this, e, t),
                    e,
                    n
                  );
                },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  i && (a = e.pageCount - a);
                  var r,
                    l = this.oldBasePageNumber,
                    h = Math.ceil(e.pageCount / s),
                    u = Math.floor(t / 2);
                  a !== this.oldBasePageNumber &&
                  ...
                  for (r = 0; r < t; r++) {
                    ...
                    if ((i && (d = h - d - 1), null != (c = this.sheets[r]))) {
                      c.targetSide =
                        r < u ? n.TURN_DIRECTION.LEFT : n.TURN_DIRECTION.RIGHT;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (this.visiblePagesCache = e), { main: e, buffer: [] };
                },
              },
              {
                key: "getBasePage",
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  n.MOUSE_SCROLL_ACTIONS.ZOOM
                    ...
                    : I(_(i.prototype), "mouseWheel", this).call(this, e);
                },
              },
              {
                key: "checkRequestQueue",
                value: function () {
                  this.app.zoomValue > 1
                    ...
                    : I(_(i.prototype), "checkRequestQueue", this).call(this);
                },
              },
                  ...
                  return (
                    (o =
                      this.app.zoomValue > 1 || !0 === n
                        ...
                        : I(_(i.prototype), "getAnnotationElement", this).call(
                            this,
                            e,
                            t
                          )) &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return this.app.zoomValue > 1 || !0 === n
                    ...
                    : I(_(i.prototype), "getTextElement", this).call(
                        this,
                        e,
                        t
                      );
                  ...
                  if (
                    (o && "-1" === o.textureStamp
                      ? ((o.textureStamp = n.textureStamp),
                        ...
                        F.log("Texture Exchanging at " + i))
                      : F.log("Texture Exchanging Bypassed at " + i),
                    !this.isBooklet)
                  ) {
                    ...
                    s && "-1" === s.textureStamp
                      ? ((s.textureStamp = a.textureStamp),
                        ...
                        F.log("Texture Exchanging at " + (i + 1)))
                      : F.log("Texture Exchanging Bypassed at " + (i + 1));
                  }
                  t.pagesReady();
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  (this.pageMode = i
                    ...
                    t.viewer.pageMode === n.FLIPBOOK_PAGE_MODE.DOUBLE &&
                    t.ui.controls.pageMode
                      ? t.ui.controls.pageMode
                          ...
                          .html(
                            "<span>" + t.options.text.singlePageMode + "</span>"
                          )
                      : t.ui.controls.pageMode
                          ...
                          .html(
                            "<span>" + t.options.text.doublePageMode + "</span>"
                          );
                },
              },
              {
              ...
              },
              {
                key: "setPage",
                value: function (e) {
                  return e.textureTarget === n.TEXTURE_TARGET.ZOOM
                    ? this.zoomViewer.setPage(e)
                    : I(_(i.prototype), "setPage", this).call(this, e);
                },
              },
              {
                ...
                value: function () {
                  var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ...
                      : void 0;
                  void 0 === e &&
                    (e = this.pageMode === n.FLIPBOOK_PAGE_MODE.SINGLE);
                  ...
                  "vertical" == this.orientation && !1 == e && (o /= 2),
                    (this._defaultPageSize = F.contain(
                      t.width,
                      t.height,
                      i,
                      o
                    )),
                    (this._pageFitArea = { width: i, height: o });
                  ...
                  var e =
                    ...
                    t =
                      arguments.length > 1 && void 0 !== arguments[1]
                        ...
                        : void 0;
                  void 0 === t &&
                    (t = this.pageMode === n.FLIPBOOK_PAGE_MODE.SINGLE);
                  var i = this.app.dimensions.stage.innerHeight;
                  return (
                    !1 === t && "vertical" == this.orientation && (i /= 2),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (void 0 !== e) {
                    ...
                    var n = e.clone();
                    return (
                      (n.width = n.width / this.getDoublePageWidthFix(t)), n
                    );
                  }
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  var e = this.app.dimensions,
                    ...
                    a = (this.fullWidth =
                      o *
                      (this.app.viewer.pageMode === n.FLIPBOOK_PAGE_MODE.SINGLE
                        ? 1
                        : 2)),
                  ...
                  1 === this.app.zoomValue && ((this.left = 0), (this.top = 0)),
                    this.element.css({
                      top: -l,
                      bottom: -l,
                      right: -h,
                    ...
                    this.wrapper.css({
                      ...
                      height: i,
                      marginTop:
                        e.height - i - t.height > 0
                          ? (e.height - t.height - i) / 2
                          : 0,
                    }),
                ...
                value: function () {
                  if (null !== this && null !== this.app.viewer) {
                    var e = this.app.viewer.centerShift,
                      ...
                      i =
                        (!t && this.app.currentPageNumber > 1) ||
                        (t && this.app.currentPageNumber < this.app.pageCount)
                          ? this.leftSheetWidth
            ...
            j(i, [
              {
                ...
                value: function () {
                  var e = "<div>",
                    t = (this.element = jQuery(e, { class: "df-sheet" })),
                  ...
                  (e = Math.floor(e)),
                    ...
                    (this.wrapper[0].style.height =
                      this.wrapper[0].style.width =
                        Math.ceil(
                          Q.distOrigin(e, t) * this.viewer.app.zoomValue
                        ) + "px"),
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    var i,
                      ...
                      r = t.viewer.isRTL,
                      l =
                        t.viewer.corner === n.TURN_CORNER.BL ||
                        t.viewer.corner === n.TURN_CORNER.BR
                          ? t.element.height()
                          : 0,
                    ...
                    !0 === t.isHard
                      ? (null != e &&
                          (u = Q.angleByDistance(e.distance, e.fullWidth)),
                        (i = t.init = { angle: u * (s ? -1 : 1) }),
                        (o = t.end =
                          t && !0 === t.animateToReset
                            ? { angle: s ? 0 : -0 }
                            : { angle: s ? -180 : 180 }))
                ...
                value: function (e) {
                  if (null != e) {
                    ...
                    var h = t - e.rx / 2,
                      ...
                      p = Math.max(
                        0,
                        Math.sin(l - Math.atan2(u, h)) * Q.distOrigin(h, u)
                      ),
                      c = 0.5 * Q.distOrigin(e.rx, e.ry),
                      ...
                      P = s ? -d : d - t,
                      S = r ? -i - f : f,
                      C = Q.limitAt((0.5 * e.distance) / t, 0, 0.5),
                      x = Q.limitAt(
          ...
          return (
            j(i, [
              ...
              },
              {
                ...
                value: function () {
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new X({ parentElement: this.wrapper });
                    (t.index = e),
                      (t.viewer = this),
                      this.sheets.push(t),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = this.app.dimensions,
                    ...
                    r = e.height,
                    l = (this.shiftHeight = Math.ceil(
                      Q.limitAt((n - r + t.height) / 2, 0, n)
                    )),
                    h = (this.shiftWidth = Math.ceil(
                      Q.limitAt((a - s + t.width) / 2, 0, a)
                    ));
                  1 === this.app.zoomValue && ((this.left = 0), (this.top = 0)),
                    this.element.css({
                      top: -l,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.seamPosition =
                    ...
                    (this.wrapperShift =
                      (this.isSingle
                        ? -this.app.dimensions.stage.innerWidth / 2
                        : 0) + t),
                  ...
                  !1 === t.isFlipping &&
                    (e.needsFlip
                      ...
                      : ((t.skipFlip = !1),
                        ...
                        t.element.addClass(
                          t.targetSide === n.TURN_DIRECTION.LEFT
                            ? "df-left-side"
                            : "df-right-side"
                        ),
                        (t.side = t.targetSide),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  var t,
                    ...
                    h,
                    u,
                    p = this.wrapper[0].getBoundingClientRect(),
                    c = this.is3D,
                    d = this.sheets,
                    f = (this.app.dimensions, { x: e.clientX, y: e.clientY }),
                    g = this.parentElement[0].getBoundingClientRect();
                  (f.x = f.x - g.left),
                    (f.y = f.y - g.top),
                    (t = (u = this.dragSheet
                      ? this.dragSheet.side === n.TURN_DIRECTION.RIGHT
                      : f.x > this.seamPosition)
                      ? this.rightSheetWidth
                      : this.leftSheetWidth),
                    ...
                    (r =
                      this.drag === n.TURN_DIRECTION.NONE
                        ? a < t
                          ? a
                          : i - a
                        : this.drag === n.TURN_DIRECTION.LEFT
                        ? a
                        : i - a),
                    (l = u
                      ? d[this.stackCount / 2]
                      : d[this.stackCount / 2 - 1]),
                    (h =
                      a < this.foldSense
                        ? n.TURN_DIRECTION.LEFT
                        : a > i - this.foldSense
                    ...
                    if (!0 === e.ctrlKey && o) this.zoomOnPoint(t);
                      ...
                      if (
                        ...
                        o &&
                          (!0 === t.isInsideCorner ||
                            (t.isInsideSheet &&
                              this.clickAction === n.MOUSE_CLICK_ACTIONS.NAV)))
                      )
                        ...
                        t.distance > t.sheetWidth / 2 &&
                          (t.sheet.side === n.TURN_DIRECTION.LEFT
                            ? this.app.openLeft()
                            : this.app.openRight()),
                          s === this.getBasePage() &&
                            ((a.animateToReset = !0), a.flip(t));
                      }
      ...
      function ea(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, ei(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
            ...
            ee(i, [
              {
                ...
                value: function () {
                  ...
                  (this.frontPage = new S()).element
                    .addClass("df-page-front")
                    .appendTo(this.element),
                    (this.backPage = new S()).element
            ...
            ee(i, [
              {
                ...
                value: function () {
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new er({ parentElement: this.wrapper });
                    (t.index = e),
                      (t.viewer = this),
                      this.sheets.push(t),
                      this.pages.push(t.frontPage),
              ...
              },
              {
                key: "eventToPoint",
                value: function (e) {
                  var t = et(ei(i.prototype), "eventToPoint", this).call(
                    this,
                    e
                  );
                  return (
              ...
              },
              {
                ...
                value: function () {
                  if (!this.isFlipping()) {
                    ...
                    this.stackCount;
                    for (
                      var n = [], o = i.currentPageNumber, a = 0;
                      a < this.stackCount / 2;
                      a++
                    )
      ...
      function eE(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, ex(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
          ...
          (ey = {
                        ...
                        : ey.textureLoader.load(
                            ...
                            function () {
                              null == r.image &&
                                ey.loadImage(
                                  t,
                                  ey.defaults.textureLoadFallback,
                                  n,
                                  o
                                ),
            ...
            loadTexture: function (t, i, n, o) {
              ...
              null !== t &&
                "map" === n &&
                ((t.anisotropy = 0),
                ey.defaults.anisotropy > 0 &&
                  (t.anisotropy = ey.defaults.anisotropy),
                !0 === e.skipPowerOfTwo &&
          ...
          var t = /*#__PURE__*/ (function (t) {
            ...
            n = /*#__PURE__*/ (function (t) {
              ...
              function o(t) {
                ...
                var r = (s.spotLight = new e.DirectionalLight(16777215, 0.25));
                return (
              ...
              return (
                ec(o, [
                  ...
                  },
                  {
                    key: "clearChild",
                    value: function () {
                      (this.spotLight.shadow.map = l.disposeObject(
          ...
          (e.CSS3DSprite = a),
            ...
            (e.CSS3DRenderer = function () {
              ...
              this.render = function (t, a) {
                var l = (0.5 / Math.tan(e.Math.degToRad(0.5 * a.fov))) * i;
                s.camera.fov !== l &&
                  ((r.style.WebkitPerspective = l + "px"),
            ...
            eS(i, [
              {
                ...
                value: function () {
                  (this.element = new ey.Paper({
                    ...
                    (this.frontPage = new eN({ sheet: this, face: 5 })),
                    (this.backPage = new eN({ sheet: this, face: 4 })),
                    this.reset(),
                    this.updateAngle();
                },
              },
                ...
                value: function () {
                  if (void 0 !== this.viewer && null !== this.viewer) {
                    ...
                    for (var b = 0; b < 1; b++) {
                      ...
                      for (
                        var P = void 0, S = r[b][0], C = 1;
                        C < r[b].length;
                        C++
                      )
                        (c += (P = r[b][C]).distanceTo(S)), d.push(c), (S = P);
                      ...
                      for (var _ = 0; _ < 1; _++)
                        for (var A = 1; A < i; A++)
                          (L[I].z = L[I + 3 * N].z = l[0][A].z),
                            ...
                            I++;
                      for (
                        var M = x.faceVertexUvs[0], D = x.faces, F = 0, z = 0;
                        z < M.length;
                        z++
                      )
                        if (D[z].materialIndex === ey.MATERIAL_FACE.BACK) {
                          var B = d[F] / c;
                          z % 2 == 0
                            ? ((M[z][0].x = M[z][1].x = M[z + 1][0].x = B), F++)
                            : (M[z - 1][2].x = M[z][1].x = M[z][2].x = B);
                        } else if (
                          D[z].materialIndex === ey.MATERIAL_FACE.FRONT
                        ) {
                          var H = 1 - d[F] / c;
                          z % 2 == 0
                            ? ((M[z][0].x = M[z][1].x = M[z + 1][0].x = H), F--)
                            : (M[z - 1][2].x = M[z][1].x = M[z][2].x = H);
                        }
                      x.computeBoundingBox(),
                        (this.element.scale.x = (1 * n) / c),
                        x.computeBoundingSphere(),
        ...
        eL = /*#__PURE__*/ (function (e) {
          ...
          function i(e, n) {
            ...
            return (
              ...
              (o.spiralCount = 20),
              (o.groundDistance =
                null !== (a = e.groundDistance) && void 0 !== a ? a : 2),
              (o.hasSpiral = "true" === e.hasSpiral || !0 === e.hasSpiral),
              (o.flexibility = eO.limitAt(
                null !== (s = e.flexibility) && void 0 !== s ? s : 0.9,
                0,
                10
              )),
            ...
            eS(i, [
                  ...
                  "undefined" == typeof THREE
                    ? (t.updateInfo(t.options.text.loading + " WEBGL 3D ..."),
                      ...
                      window.requirejs
                        ...
                        : eO.getScript(
                            t.options.threejsSrc + "?ver=" + n.version,
                            function () {
                              ey.init(), "function" == typeof e && e();
                            },
                            function () {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = this.app;
                  (this.has3DCover =
                    e.options.cover3DType !== n.FLIPBOOK_COVER_TYPE.NONE &&
                    e.pageCount > 7 &&
                    !this.isBooklet),
                    this.has3DCover &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (e.canvas = jQuery(e.renderer.domElement).addClass(
                    "df-3dcanvas"
                  )).appendTo(this.element),
                    ...
                    (e.spotLight.castShadow =
                      !eO.isMobile && this.app.options.has3DShadow),
                ...
                value: function () {
                  eC(ex(i.prototype), "dispose", this).call(this),
                    this.stage &&
                      ...
                      (this.stage.orbitControl = eO.disposeObject(
                        this.stage.orbitControl
                      )),
                      (this.stage.renderer = eO.disposeObject(
                        this.stage.renderer
                      )),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.coverExtraWidth =
                    ("vertical" == e.orientation ? 2 : 1) * r * 0.025),
                    (this.coverExtraHeight =
                      ("vertical" == e.orientation ? 1 : 2) * r * 0.025),
                    !0 !== this.has3DCover &&
              ...
              },
              {
                ...
                value: function (e, t, i, n) {
                  ...
                  var l = e.fov * (Math.PI / 180),
                    ...
                    u = Math.max(
                      a.z / 2 + Math.abs(a.x / 2 / Math.tan(h / 2)),
                      a.z / 2 + Math.abs(a.y / 2 / Math.tan(l / 2))
                    );
              ...
              { key: "updateShadowSize", value: function () {} },
              {
                ...
                value: function () {
                  ...
                  (this.leftFlexibility = r * (1 - o)),
                    ...
                    (this.midPosition = 0.5 * a * this.sheetDepth),
                      ...
                      0 !== e.options.flipbook3DTiltAngleLeft
                        ? ((t.camera.aspect = i.stage.width / i.stage.height),
                          ...
                          this.cameraWrapper.rotateX(
                            THREE.Math.degToRad(e.options.flipbook3DTiltAngleUp)
                          ),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (i.leftFlexibility = s ? this.leftFlexibility : 0),
                    ...
                    (i.leftPos =
                      this.midPosition +
                      (o - e.midPoint + 1) * this.sheetDepth -
                      this.sheetDepth / 2),
                    (i.rightPos =
                      this.midPosition -
                      (o - e.midPoint) * this.sheetDepth -
                      this.sheetDepth / 2),
                    ...
                    !1 === i.isFlipping &&
                      (e.needsFlip
                        ? ((i.isFlipping = !0),
                          ...
                          (i.element.position.z =
                            Math.max(
                              a < 90 ? i.leftPos : i.rightPos,
                              this.midPosition
                            ) + this.sheetDepth),
                          (i.flexibility =
                            a < 90 ? i.leftFlexibility : i.rightFlexibility),
                          i.flip(a, t))
                        : ((i.skipFlip = !1),
                  ...
                  if (!this.isAnimating() && !0 === this.refreshRequested) {
                    if (!1 === this.app.options.flipbookFitPages) {
                      ...
                      if (i) {
                        ...
                        (this.rightSheetWidth != Math.floor(a.width) ||
                          this.rightSheetWidth != Math.floor(a.height)) &&
                          (this.cameraPositionDirty = !0),
                          (this.rightSheetWidth = Math.floor(a.width)),
                          (this.rightSheetHeight = Math.floor(a.height));
                      }
                      ...
                      if (this.isClosedPage()) {
                        ...
                        (this.leftCover.width = this.rightCover.width =
                          l ? this.rightSheetWidth : this.leftSheetWidth),
                          (this.leftCover.height = this.rightCover.height =
                            l ? this.rightSheetHeight : this.leftSheetHeight);
                      } else
                        (this.leftCover.height = this.rightCover.height =
                          this.coverExtraHeight +
                          Math.max(
                    ...
                    if (1 === this.app.zoomValue) {
                      if (null !== this.dragSheet) {
                        ...
                        Math.abs(i) > 2 * this.swipeThreshold &&
                          (this.drag === n.TURN_DIRECTION.LEFT && i > 0
                            ? this.app.openLeft()
                            : this.drag === n.TURN_DIRECTION.RIGHT &&
                              i < 0 &&
                              this.app.openRight()),
                          this.requestRefresh(),
                          this.updatePendingStatusClass();
                    ...
                    if (null != e.touches && 2 === e.touches.length)
                      ...
                      var i = this.raycastCLick(e),
                        o = t.sheet
                          ...
                          : 0;
                      t.sheet && i && t.isInsideSheet && o < t.sheet.width / 2
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this.app.dimensions,
                    i = { x: (e = eO.fixMouseEvent(e)).clientX, y: e.clientY };
                  (i.x =
              ...
              },
              {
                key: "getTextureSize",
                value: function (e) {
                  var t = eC(ex(i.prototype), "getTextureSize", this).call(
                    this,
                    e
                  );
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return eC(ex(i.prototype), "getPageByNumber", this).call(
                    this,
                    e
                  );
                },
            ...
            eS(i, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (t.textureSrc = i),
                    "function" == typeof n.defaults.beforeLoadTexture &&
                      n.defaults.beforeLoadTexture({ texture: i, page: t }),
                    4 === this.face
                      ? this.sheet.backImage(i, a)
                      : this.sheet.frontImage(i, a);
                },
              },
            ]),
            i
      ...
      function eF(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, eA(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
      ...
      (eL.prototype.resizeAnnotations = function (e) {
        ...
        (eL.prototype.updateCSSLayer = function () {
          ...
          jQuery(this.stage.cssRenderer.domElement)
        ...
        (eL.prototype.set3DCoverNormal = function () {
          ...
          if (e !== n.FLIPBOOK_COVER_TYPE.PLAIN) {
            var t,
              i = e == n.FLIPBOOK_COVER_TYPE.RIDGE;
            ...
            (l.fillStyle = o),
              ...
              (t = l.createLinearGradient(126.08, 0, 128, 0)).addColorStop(
                0,
                o
              ),
              t.addColorStop(1, "rgb(255,127,255)"),
              ...
              l.closePath(),
              l.fill(),
              (t = l.createLinearGradient(0, 126.08, 0, 128)).addColorStop(
                0,
                o
              ),
              t.addColorStop(1, "rgb(127,0,255)"),
        ...
        (eL.prototype.setcolor3DCover = function () {
          ...
          if (
            ...
            (s.lineWidth = 2),
            s.moveTo(0, 0),
            s.lineTo(0.1 * o, 0.05 * o),
            s.stroke(),
            s.beginPath(),
            (s.strokeStyle = "rgba(50,50,50," + (i / 2 + 0.4) + ")"),
            s.moveTo(0, o),
            s.lineTo(0.1 * o, 0.95 * o),
            s.stroke(),
            s.beginPath(),
            ...
            s.beginPath();
            var r = s.createLinearGradient(0.95 * o, 0, o, 0);
            r.addColorStop(0, "rgba(30,30,30," + (i + 0.3) + ")"),
              r.addColorStop(1, "rgba(60,60,60," + (i + 0.3) + ")"),
              (s.fillStyle = r),
              s.fillRect(0.95 * o, 0, 0.05 * o, o),
              s.beginPath(),
              (s.lineWidth = 1),
              (s.strokeStyle = "rgba(40,40,40," + (i + 0.3) + ")");
            for (var l = 0; l < 17; l++)
              s.moveTo(o - 3 * l, 0), s.lineTo(o - 3 * l, o);
            s.stroke();
          } else
            s.beginPath(),
          ...
          if (
            ((u.fillStyle = e),
            u.fillRect(0, 0, o, o),
            (u.strokeStyle = "rgba(50,50,50," + (i / 2 + 0.5) + ")"),
            u.strokeRect(
            ...
            u.beginPath(),
            (u.strokeStyle = "rgba(50,50,50," + (i / 2 + 0.3) + ")"),
            (u.lineWidth = 2),
            u.moveTo(o, 0),
            u.lineTo(0.9 * o, 0.05 * o),
            u.stroke(),
            u.beginPath(),
            (u.strokeStyle = "rgba(50,50,50," + (i / 2 + 0.5) + ")"),
            u.moveTo(o, o),
            u.lineTo(0.9 * o, 0.95 * o),
            u.stroke(),
            u.beginPath(),
            ...
            u.beginPath();
            var p = u.createLinearGradient(0, 0, 0.05 * o, 0);
            p.addColorStop(0, "rgba(0,0,0," + (i + 0.3) + ")"),
              p.addColorStop(0.2, "rgba(10,10,10," + (i + 0.3) + ")"),
              p.addColorStop(1, "rgba(80,80,80," + (i + 0.3) + ")"),
              (u.fillStyle = p),
              u.fillRect(0, 0, 0.05 * o, o),
              u.beginPath(),
              (u.lineWidth = 1),
              (u.strokeStyle = "rgba(40,40,40," + (i + 0.3) + ")");
          ...
          if (!0 === this.hasSpiral) {
            ...
            this.bookWrapper.children.forEach(function (t) {
              ...
              (this.rightHoles.visible = this.isBooklet
                ? !this.isRTL
                : !1 == this.isRightClosed && !1 == this.rightCover.isFlipping);
            var t =
              "vertical" === this.orientation
                ? Math.max(
      ...
      var eB = /*#__PURE__*/ (function (e) {
          ...
          function o(e, t) {
            return (
              ...
              (e.hasSpiral = !1),
              (e.flexibility = 0),
              (e.cover3DType === n.FLIPBOOK_COVER_TYPE.RIDGE ||
                e.cover3DType === n.FLIPBOOK_COVER_TYPE.BASIC) &&
                (e.cover3DType = n.FLIPBOOK_COVER_TYPE.PLAIN),
              i.call(this, e, t)
            );
          }
          return (
              ...
              },
              {
                ...
                value: function (e) {
                  var t =
                    ...
                    void 0 !== arguments[1] &&
                    arguments[1];
                  return e_(eA(o.prototype), "getAnnotationElement", this).call(
                    this,
                    e,
                    t,
                    !0
              ...
              },
              {
                ...
                value: function (e) {
                  var t =
                    ...
                    void 0 !== arguments[1] &&
                    arguments[1];
                  return e_(eA(o.prototype), "getTextElement", this).call(
                    this,
                    e,
                    t,
                    !0
              ...
              },
              {
                ...
                value: function (e, t) {
                  (this.skipCenterAnimation = !0),
                    e_(eA(o.prototype), "exchangeTexture", this).call(
                      this,
                      e,
                      t
                    ),
                      ...
                      a
                        ? ((a = n.pdfApp.viewer.getViewerPageNumber(a)) >
                          ...
                          t.num + " " + t.gen + " R"
                            ...
                            : eQ.log("Expired Request for ", a, " with ", t))
                  ...
                  if ("" !== e && null != e && "null" !== e) {
                    ...
                    if (isNaN(Math.floor(e))) {
                      if (
                        ...
                        window.open(
                          e,
                          this.pdfApp.options.linkTarget === n.LINK_TARGET.SELF
                            ? "_self"
                            : "_blank"
                        );
                        return;
                  ...
                  if (eq(e, Array)) {
                    ...
                    if (i) {
                      var n = this.getAnchorUrl("#page=" + i),
                        o = e[1];
                      if (
                        (void 0 === o ? "undefined" : eK(o)) === "object" &&
                        "name" in o &&
                        "XYZ" === o.name
                      ) {
          ...
          var t,
            o =
              ...
              function () {
                ...
                return (
                  (e = t
                    ? Reflect.construct(i, arguments, eG(this).constructor)
                    : i.apply(this, arguments)),
                  e && ("object" === eK(e) || "function" == typeof e)
                    ? e
                    : eU(this)
                );
              });
          function a(e, t) {
            ...
            var s,
              ...
              l = function (e) {
                ...
                (t.href = h.options.pdfjsWorkerSrc + u.cacheBustParameters),
                  ...
                  !0 === n.loadCorsPdfjsWorker
                    ? (h.updateInfo(
                        h.options.text.loading + " PDF Worker CORS ..."
                      ),
                      jQuery.ajax({
                        url: h.options.pdfjsWorkerSrc + u.cacheBustParameters,
                        cache: !0,
                        success: function (t) {
                          (h.options.pdfjsWorkerSrc = eQ.createObjectURL(
                            t,
                            "text/javascript"
                          )),
                            "function" == typeof e && e();
            ...
            return (
              ...
              (u.cacheBustParameters =
                "?ver=" + n.version + "&pdfver=" + h.options.pdfVersion),
              (r = function () {
                (pdfjsLib.GlobalWorkerOptions.workerSrc =
                  h.options.pdfjsWorkerSrc + u.cacheBustParameters),
                  (pdfjsLib.canvasWillReadFrequently =
                    n.defaults.canvasWillReadFrequently),
                  u.loadDocument();
              }),
              "undefined" == typeof pdfjsLib
                ? (h.updateInfo(h.options.text.loading + " PDF Service ..."),
                  eQ.getScript(
                    h.options.pdfjsSrc + u.cacheBustParameters,
                    function () {
                      ...
                      window.require.config
                        ? (h.updateInfo(
                            h.options.text.loading +
                              " PDF Service (require) ..."
                          ),
                          window.require.config({
                            paths: {
                              "pdfjs-dist/build/pdf.worker":
                                h.options.pdfjsWorkerSrc.replace(".js", ""),
                            },
                          }),
                          window.require(
                    ...
                    h.options.pdfjsSrc.indexOf("pdfjs-4") > 1
                  ))
                : "function" == typeof r && r(),
              s
            );
              ...
              },
              {
                ...
                value: function () {
                  var e = this.app,
                    ...
                    n = t.pdfParameters || {};
                  if (
                    ((n.url = eQ.httpsCorrection(n.url || t.source)),
                      ...
                      .then(function (n) {
                        (i.pdfDocument = n),
                          n.getPage(1).then(function (o) {
                            i.defaultPage = o;
                            var a,
                              s = (i.defaultPage.viewPort = o.getViewport({
                                scale: 1,
                                rotation:
                  ...
                  eQ.log("Requesting PDF Page:" + s),
                    i.pdfDocument
                      ...
                      .then(function (r) {
                        ...
                        var l,
                          h = t.viewer.getRenderContext(r, e);
                        e.isFreshPage &&
                          (null ===
                            (l = t.viewer.getPageByNumber(e.pageNumber)) ||
                            void 0 === l ||
                            l.changeTexture(e.pageNumber, h.canvas.height)),
                          eQ.log(
                            "Page " +
                              n +
                              " rendering - " +
                          ...
                          r
                            ...
                            .promise.then(function () {
                              if (
                                (t.applyTexture(h.canvas, e),
                                !0 === DEARFLIP.defaults.cachePDFTexture &&
                                  i.setCache(e.pageNumber, h.canvas, a.height),
                                ...
                                eQ.log(
                                  ...
                                  i.requestedPages.indexOf(l) > -1 &&
                                    ((i.requestedPages =
                                      i.requestedPages.replace(l, "")),
                                    -1 ==
                                    i.requestedPages.indexOf("[" + s + "|")
                                      ? (eQ.log(
                                          "CleanUp Passed for (" +
                                            n +
                                            ") actual " +
                  ...
                  if (void 0 == n.textContentJoinedSearch[t] || i) {
                    ...
                    for (var l = 0; l < e.items.length; l++)
                      (o = e.items[l]),
                        ...
                        n.textOffset[t].push({ length: r, offset: a - r });
                    (n.textContentJoinedSearch[t] =
      ...
      var e8 = n.utils,
          ...
          function e(t) {
            ...
            for (var i = 0; i < t.length; i++)
              (this.source[i] = e8.httpsCorrection(t[i].toString())),
                this.pages.push(new e9({ src: this.source[i] }));
          }
          return (
            e2(e, [
              {
        ...
        e6 = /*#__PURE__*/ (function (e) {
          ...
          function n(e, t) {
            e0(this, n);
            var o,
              a = (o = i.call(this, e, t)).app,
              s = e$(o);
            return (
              (s.document = new e4(a.options.source)),
              ...
              { key: "dispose", value: function () {} },
              {
                ...
                value: function () {
                  ...
                  i.document.getPage(1).then(function (n) {
                    i.defaultPage = n;
                    var o,
                      a = (i.defaultPage.viewPort = n._viewPort),
      ...
      var to = n.jQuery,
        ...
        tr = /*#__PURE__*/ (function () {
          function e(t, i) {
            te(this, e),
              ...
              (this.element = to("<div>", { class: "df-ui" })),
              (this.leftElement = to("<div>", { class: "df-ui-left" }).appendTo(
                this.element
              )),
            ...
            ti(e, [
              {
                ...
                value: function () {
                  ...
                  (this.pageInput = o.pageInput =
                    to('<input id="' + r + '" type="text"/>').appendTo(
                      o.pageNumber
                    )),
                    (this.pageLabel = o.pageLabel =
                      to('<label for="' + r + '"></label>').appendTo(
                        o.pageNumber
                      )),
                    ...
                    i.hasOutline() &&
                      ((this.outline = o.outline =
                        ta.createBtn("outline", s.outline, a.toggleOutline)),
                      o.outline
                        .on("click", function () {
                          var t = to(this);
                          if (
                    ...
                    !0 === i.options.showSearchControl &&
                      ...
                      ((o.search = ta.createBtn("search", s.search, a.search)),
                      o.search
                        .on("click", function () {
                          var t = to(this);
                          if (
                  ...
                  if (
                    ((this.zoomIn = o.zoomIn =
                      ta
                        .createBtn("zoomin", s.zoomin, a.zoomIn)
                        .on("click", function () {
                          i.zoom(1), e.update();
                        })),
                    (this.zoomOut = o.zoomOut =
                      ta
                        .createBtn("zoomout", s.zoomout, a.zoomOut)
                        .on("click", function () {
                          i.zoom(-1), e.update();
                        })),
                    (this.resetZoom = o.resetZoom =
                      ta
                        .createBtn("resetzoom", s.resetzoom, a.resetZoom)
                        .on("click", function () {
                    ...
                    if (i.pageCount > 2) {
                      ...
                      this.pageMode = o.pageMode = ta
                        .createBtn(
                          "pagemode",
                          s[h ? "doublepage" : "singlepage"],
                          h ? a.doublePageMode : a.singlePageMode
                        )
                        .on("click", function () {
                          var e = to(this);
                    ...
                    this.pageFit = o.pageFit = ta
                      .createBtn("pagefit", s.pagefit, a.pageFit)
                      .on("click", function () {
                        var e = o.pageFit;
                  ...
                  if (
                    ((e.shareBox = new tl(i.container, i.options)),
                    (this.share = o.share =
                      ta
                        .createBtn("share", s.share, a.share)
                        .on("click", function () {
                          !0 === e.shareBox.isOpen
                            ? e.shareBox.close()
                    ...
                    (this.more = o.more =
                      ta.createBtn("more", s.more).on("click", function (t) {
                        !0 !== e.moreContainerOpen &&
                          (to(this).addClass("df-active"),
                          (e.moreContainerOpen = !0),
                          t.stopPropagation());
                      })),
                    (this.startPage = o.startPage =
                      ta
                        .createBtn("start", s.start, a.gotoFirstPage)
                        .on("click", function () {
                          i.start();
                        })),
                    (this.endPage = o.endPage =
                      ta
                        .createBtn("end", s.end, a.gotoLastPage)
                        .on("click", function () {
                          i.end();
                        })),
                    !0 === i.options.showPrintControl &&
                      ...
                      (this.print = o.print =
                        ta
                          .createBtn("print", s.print, a.print)
                          .on("click", function () {
                    ...
                    (this.download = o.download =
                      ...
                      o.download
                        .attr("href", ta.httpsCorrection(i.options.source))
                        .attr("title", a.downloadPDFFile);
                  }
                  (e.moreContainer = to(t, { class: "df-more-container" })),
                  ...
                  for (var f = 0; f < p.length; f++) {
                    ...
                    if (0 > d.indexOf("," + g + ",")) {
                      var v = o[g];
                      null != v &&
                        (void 0 === v ? "undefined" : tn(v)) == "object" &&
                        (c.indexOf("," + g + ",") > -1 &&
                        "more" !== g &&
                        "pageNumber" !== g
              ...
              },
              {
                ...
                value: function (e) {
                  void 0 === ta.getFullscreenElement() &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if ("INPUT" !== e.target.nodeName) {
                    var i = !1;
                    switch (
                      (t.options.arrowKeysAction === n.ARROW_KEYS_ACTIONS.NAV &&
                        ((!0 === t.isFullscreen ||
                          !0 === t.options.isLightBox) &&
                          (i = !0),
                        !0 != t.options.isLightBox &&
                          n.activeEmbeds.length < 2 &&
                          !1 === to("body").hasClass("df-lightbox-open") &&
                          (i = !0)),
                      e.keyCode)
                    ) {
                      case 27:
                        n.activeLightBox &&
                          n.activeLightBox.app &&
                          !ta.isChromeExtension() &&
                          n.activeLightBox.closeButton.trigger("click");
                        break;
                      case 37:
                        i && t.openLeft();
                        break;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.options.logo.indexOf("<") > -1
                    ? (t = to(e.options.logo).addClass("df-logo df-logo-html"))
                ...
                value: function () {
                  for (var e in this.controls)
                    if (this.controls.hasOwnProperty(e)) {
                      ...
                      null !== t &&
                        (void 0 === t ? "undefined" : tn(t)) == "object" &&
                        t.off().remove();
                    }
                  this.element.remove(),
                  ...
                  if ((e.container.toggleClass("df-search-open", n), n)) {
                    ...
                    if (
                      ...
                      (o = o[0]).offsetTop + o.scrollHeight
                        ? ta.scrollIntoView(o, null, !1)
                        : s > o.offsetTop && ta.scrollIntoView(o);
                    }
                  }
        ...
        th = /*#__PURE__*/ (function () {
          function e(t) {
            ...
            var i = this;
            return (
              (i.lightboxWrapper = to("<div>").addClass("df-lightbox-wrapper")),
              (i.backGround = to("<div>")
              ...
              (i.controls = to("<div>")
                ...
                .appendTo(i.lightboxWrapper)),
              (i.closeButton = to("<div>")
                .addClass(
                  "df-lightbox-close df-ui-btn " + n.defaults.icons.close
                )
                .on("click", function () {
                  i.close(t);
                })
                ...
                value: function (e) {
                  return (
                    0 === this.lightboxWrapper.parent().length &&
                      to("body").append(this.lightboxWrapper),
        ...
        tp = /*#__PURE__*/ (function () {
          function e(t, i) {
            te(this, e),
              ...
              (this.app = i),
              (this.parentElement = t.parentElement),
              (this.element = to("<div>", { class: "df-sidemenu-wrapper" })),
              this.parentElement.append(this.element),
              (this.buttons = to("<div>", {
                class: "df-sidemenu-buttons df-ui-wrapper",
              }).appendTo(this.element)),
              (this.close = ta.createBtn(
                "close",
                    ...
                    a.length > 0
                      ? (e.thumbContainer
                        ...
                        i + o < (a = a[0]).offsetTop + a.scrollHeight
                          ? ta.scrollIntoView(a, null, !1)
                          : i > a.offsetTop && ta.scrollIntoView(a),
                        (e.activeThumb = e.currentPageNumber))
                      : (to(t).scrollTop(124 * e.currentPageNumber),
                ...
                value: function (e) {
                  ...
                  if (e.textureTarget === n.TEXTURE_TARGET.THUMB) {
                    ...
                    a
                      ...
                      a
                        .find(".df-bg-image")
                        .css({ backgroundImage: ta.bgImage(o) }),
                      a
      ...
      function tf() {
        if (void 0 === n.openLocalFileInput) {
          var e = (n.openLocalFileInput = to(
            '<input type="file" accept=".pdf" style="display:none">'
          )
            .appendTo(to("body"))
            .data("df-option", n.openFileOptions));
          e.change(function () {
            var t,
              i = e[0].files;
      ...
      (n.openLightBox = function (e) {
        n.activeLightBox ||
          (n.activeLightBox = new th(function () {
            n.activeLightBox.app &&
              ((n.activeLightBox.app.closeRequested = !0),
          ...
          (void 0 === n.activeLightBox.app ||
            null === n.activeLightBox.app ||
            !0 === n.activeLightBox.app.closeRequested ||
            n.openLocalFileInput == e) &&
            ((n.activeLightBox.app = ta.disposeObject(n.activeLightBox.app)),
            null === n.activeLightBox.app &&
              n.activeLightBox.show(function () {
                (n.activeLightBox.app = to(n.activeLightBox.element).dearviewer(
                  ...
                  n.activeLightBox.lightboxWrapper.toggleClass(
                    "df-lightbox-padded",
                    !1 === n.activeLightBox.app.options.popupFullsize
                  ),
                  n.activeLightBox.lightboxWrapper.toggleClass(
                    "df-rtl",
                    n.activeLightBox.app.options.readDirection ===
                      n.READ_DIRECTION.RTL
                  ),
                  n.activeLightBox.backGround.css({
                    backgroundColor:
                      "transparent" ===
                      n.activeLightBox.app.options.backgroundColor
                        ? n.defaults.popupBackGroundColor
                        : n.activeLightBox.app.options.backgroundColor,
                  });
              }));
      }),
        ...
        (n.fileDropHandler = function (e, t) {
          ...
          "application/pdf" === i.type &&
            (t.preventDefault(), t.stopPropagation(), n.openFile(i));
        }),
        (n.openFile = function (e) {
          if (e) {
            var t;
            n.oldLocalFileObjectURL &&
              window.URL.revokeObjectURL(n.oldLocalFileObjectURL),
              (n.oldLocalFileObjectURL = window.URL.createObjectURL(e)),
              null === (t = n.openFileSelected) ||
                void 0 === t ||
                t.call(n, { url: n.oldLocalFileObjectURL, file: e }),
        ...
        (n.openBase64 = function (e) {
          (n.openFileOptions.source = null),
            (n.openFileOptions.pdfParameters = { data: atob(e) }),
            n.openURL();
        }),
        ...
        (n.initControls = function () {
          var e = to("body");
          if (
            (!1 !== n.defaults.autoPDFLinktoViewer &&
            ...
            (n.handlePopup = function (e) {
              ...
              if ((n.toggleClass("df-active", t), t)) {
                ...
                if (e.hasClass("popupTriggerArea")) {
                  ...
                  void 0 !== r &&
                    (s = e.siblings("[data-annotation-id=popup_" + r + "]"));
                }
                n.html(s.html());
                var l = o.left - a.left;
                l + 360 > a.width
        ...
        ty = /*#__PURE__*/ (function () {
          ...
          function t(e) {
            ...
            (function (e, t) {
              ...
              (this.is3D = e.is3D),
              (this.options.pixelRatio = tm.limitAt(
                this.options.pixelRatio,
                1,
                this.options.maxDPI
              )),
              (this.options.fakeZoom =
                null !== (o = this.options.fakeZoom) && void 0 !== o ? o : 1),
              (this.events = {}),
              (this.links = e.links),
              (this.thumbSize = 128),
              (this.pendingZoom = !0),
              ...
              (this.isExternalReady =
                null === (a = this.options.isExternalReady) ||
                void 0 === a ||
                a),
              this.init(),
          ...
          return (
            (e = [
              ...
              },
              {
                ...
                value: function () {
                  this.element
                    ...
                    this.container.addClass(
                      "df-container df-loading df-init df-controls-" +
                        ...
                        ("transparent" === this.options.backgroundColor
                          ...
                          : "") +
                        (!0 === this.isRTL ? " df-rtl" : "") +
                        (!0 === tm.isIOS || !0 === tm.isIPad ? " df-ios" : "")
                    ),
                    (this._offsetParent = this.container[0].offsetParent),
                    (this.backGround = tg("<div class='df-bg'>")
                      .appendTo(this.container)
                      .css({
                    ...
                    (this.viewerContainer = tg("<div>").appendTo(
                      this.container
                    )),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (void 0 !== window[n.locationVar]) {
                    if (
                      ((e.pdfjsSrc =
                        window[n.locationVar] + "js/libs/pdf.min.js"),
                      (e.threejsSrc =
                        window[n.locationVar] + "js/libs/three.min.js"),
                      (e.pdfjsWorkerSrc =
                        window[n.locationVar] + "js/libs/pdf.worker.min.js"),
                      (e.soundFile = window[n.locationVar] + e.soundFile),
                      (e.imagesLocation =
                        window[n.locationVar] + e.imagesLocation),
                      (e.imageResourcesPath =
                        window[n.locationVar] + e.imageResourcesPath),
              ...
              },
              {
                ...
                value: function (e) {
                  (this.userHasInteracted = !0),
                    !0 === this.viewer.acceptAppMouseEvents &&
                      0 === tg(e.srcElement).closest(".df-sidemenu").length &&
              ...
              },
              {
                ...
                value: function () {
                  (this.viewer = new this.viewerType(this.options, this)),
                    (this.provider = new n.providers[this.options.providerType](
                      this.options,
                      this
                    )),
                    (this.softDisposed = !1);
              ...
              },
              {
                key: "initInfo",
                value: function () {
                  (this.info = tg("<div>", { class: "df-loading-info" })),
                ...
                value: function () {
                  this.resize(),
                    ...
                    !0 ===
                      ...
                      (tm.focusHash(this.options.dataElement),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.append(
                    ...
                    (e.searchForm = tg('<div class="df-search-form">').appendTo(
                      t
                    )),
                    (e.searchBox = tg(
                    ...
                    (e.searchButton = tg(
                      ...
                      .appendTo(e.searchForm)),
                    (e.clearButton = tg('<a class="df-search-clear">Clear</a>')
                      .on("click", function (t) {
                        e.clearSearch();
                      })
                      .appendTo(e.searchForm)),
                    (e.searchInfo = tg('<div class="df-search-info">').appendTo(
                      t
                    )),
                    (e.searchResults = tg(
                  ...
                  if (
                    ...
                    for (var l = 0; l < a.length; l++) {
                      ...
                      if (
                        ...
                        h <= this.pageCount &&
                        ((e = r
                          ? i.zoomViewer.getPageByNumber(h)
                          : i.getPageByNumber(h)) &&
                          ((t = i.getTextureSize({ pageNumber: h })),
                          e.changeTexture(h, Math.floor(t.height)) &&
                            (o.processPage({
                              pageNumber: h,
                              textureTarget: r
                                ? n.TEXTURE_TARGET.ZOOM
                                : n.TEXTURE_TARGET.VIEWER,
                            }),
                            s++,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var r = (o.controlsHeight = this.container
                    .find(".df-ui")
                    .height());
                  if (
                    ((a.top =
                      this.options.paddingTop +
                      (this.options.controlsPosition === n.CONTROLS_POSITION.TOP
                        ? r
                        : 0)),
                    ...
                    (o.containerWidth = o.isFullSize
                      ? tg(window).width()
                      : this.element.width()),
                    this.container
                      .toggleClass("df-xs", o.containerWidth < 400)
                      .toggleClass("df-xss", o.containerWidth < 320),
                    (o.maxHeight =
                      s -
                      (o.containerWidth > 600 &&
                      null !==
                        (t = tg(
              ...
              },
              {
                ...
                value: function () {
                  if (null != this.options.id) {
                    var e =
                      tm.getSharePrefix(this.options.sharePrefix) +
      ...
      function tb(e, t, i) {
        for (
          var n = [], o = !1, a = 0, s = 0, r = 0, l = void 0, h = 0, u = 0;
          u < e.length;
          u++
        ) {
          var p,
          ...
          for (
            r = (s = t[u].offset) + t[u].length,
              !1 == o &&
                ((l = null === (p = i[h]) || void 0 === p ? void 0 : p.index),
                (a = null === (c = i[h]) || void 0 === c ? void 0 : c.length));
            l >= s && l < r;

          )
            g.searchHits || (g.searchHits = []),
              g.searchHits.push({ start: l - s, length: a, text: i[h].text }),
      ...
      (n.prepareOptions = function (e) {
        (t = e.element),
          (null != tg && "undefined" != typeof Symbol && tg[Symbol.hasInstance]
            ? tg[Symbol.hasInstance](t)
            : t instanceof tg) || (e.element = tg(e.element));
        var t,
          i = e.element;
        ...
        return (
          tm.isMobile &&
            "function" == typeof n.viewers[r.mobileViewerType] &&
            (r.viewerType = r.mobileViewerType),
          "function" != typeof n.viewers[r.viewerType]
            ? (console.warn(
                "Invalid Viewer Type! " +
                  r.viewerType +
                  " | Using default Viewer!"
              ),
              (r.viewerType = n.viewers.default))
            : (r.viewerType = n.viewers[r.viewerType]),
        ...
        (n.openAttachmentLightBoxes = function () {
          ...
          e.length > 0 && jQuery(e[0]).trigger("click"),
            jQuery(window).on("hashchange", function (e) {
              ...
              t &&
                t.length > 5 &&
                ((n.hashFocusBookFound = !1), l.detectHash());
            });
        }),
                ...
                i.pdfDocument.getPage(a).then(function (s) {
                  ...
                  (r = s.getViewport({
                    ...
                    s.getTextContent().then(function (s) {
                      ...
                      void 0 == c &&
                        void 0 != i.textOffsetSearch[a] &&
                        d &&
                        d.length > 0 &&
                        ((c = tb(s.items, i.textOffsetSearch[a], d)),
        ...
        (eJ.prototype.renderAutoLinks = function (e, t, i, n) {
          if (e && e.length > 0) {
            var o,
              a,
              s = jQuery(i).siblings(".df-auto-link-content");
            0 === s.length &&
              ((s = jQuery('<div class="df-auto-link-content">')),
              jQuery(i).parent().prepend(s)),
              s.html(""),
              (t.items = e),
              pdfjsLib.TextLayer
                ? (a = (o = new pdfjsLib.TextLayer({
                    textContentSource: t,
                    viewport: n,
                    container: s[0],
                  })).render())
                : (a = (o = pdfjsLib.renderTextLayer({
                    textContentSource: t,
                    textContent: t,
                    container: s[0],
                    viewport: n,
              ...
              (null !== (i = o.textDivs) && void 0 !== i
                ...
                for (s = 0; s < i.searchHits.length; s++)
                  (n += i.str.substring(o, i.searchHits[s].start)),
                    ...
                    void 0 !== (u = i.searchHits[s].text) &&
                      (h.indexOf("@") > 0
                        ? (u = u.toLowerCase()).indexOf(!1) &&
                          (u = "mailto:" + h)
                        : 0 === u.indexOf("www.") && (u = "http://" + u),
                      (n +=
                        '<a href="' +
                        u +
                        '" class="df-autolink" target="_blank">' +
      ...
      (tP.defaults.viewerType = "flipbook"),
        ...
        (tP.locationFile = "dflip"),
        (tP.PAGE_MODE = { SINGLE: 1, DOUBLE: 2, AUTO: null }),
        (tP.SINGLE_PAGE_MODE = { ZOOM: 1, BOOKLET: 2, AUTO: null }),
        (tP.CONTROLSPOSITION = {
          HIDDEN: "hide",
          TOP: "top",
          BOTTOM: "bottom",
        }),
        (tP.DIRECTION = { LTR: 1, RTL: 2 }),
        (tP.PAGE_SIZE = { AUTO: 0, SINGLE: 1, DOUBLEINTERNAL: 2 }),
        (tP.ConvertPageLinks = function () {
          for (
            var e,
              t = arguments[0] / 100,
              i = arguments[1] / 100,
              n = function (e, n, o, a, s) {
                return { x: e / t, y: n / i, w: o / t, h: a / i, dest: s };
              },
              o = [],
              a = 2;
            a < arguments.length;
          ...
          if (null != e && e.length > 0)
            for (var i = 0; i < e.length; i++)
              null != (t = e[i]) &&
                null != t[0] &&
                null == t[0].dest &&
                ((t = tP.ConvertPageLinks.apply(this, t)), (e[i] = t));
          return e;
        }),
        ...
        if (
          ...
          null != e.cover3DType &&
            (!0 == e.cover3DType || "true" == e.cover3DType
              ? (e.cover3DType = tP.FLIPBOOK_COVER_TYPE.BASIC)
              : (!1 == e.cover3DType || "false" == e.cover3DType) &&
                (e.cover3DType = tP.FLIPBOOK_COVER_TYPE.NONE)),
          void 0 !== e.pageSize &&
            ("1" === e.pageSize ||
            1 === e.pageSize ||
            e.pageSize === tP.FLIPBOOK_PAGE_SIZE.SINGLE
              ? (e.pageSize = tP.FLIPBOOK_PAGE_SIZE.SINGLE)
              : "2" === e.pageSize ||
                2 === e.pageSize ||
                e.pageSize === tP.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL
              ? (e.pageSize = tP.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL)
              : e.pageSize === tP.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK ||
                (e.pageSize = tP.FLIPBOOK_PAGE_SIZE.AUTO)),
          void 0 !== e.pageMode &&
            ("1" === e.pageMode ||
            1 === e.pageMode ||
            e.pageMode === tP.FLIPBOOK_PAGE_MODE.SINGLE
              ? (e.pageMode = tP.FLIPBOOK_PAGE_MODE.SINGLE)
              : "2" === e.pageMode ||
                2 === e.pageMode ||
                e.pageMode === tP.FLIPBOOK_PAGE_MODE.DOUBLE
              ? (e.pageMode = tP.FLIPBOOK_PAGE_MODE.DOUBLE)
              : (e.pageMode = tP.FLIPBOOK_PAGE_MODE.AUTO)),
          void 0 !== e.singlePageMode &&
            ("1" === e.singlePageMode ||
            1 === e.singlePageMode ||
            e.singlePageMode === tP.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM
              ? (e.singlePageMode = tP.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM)
              : "2" === e.singlePageMode ||
                2 === e.singlePageMode ||
                e.singlePageMode === tP.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET
              ? (e.singlePageMode = tP.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET)
              : (e.singlePageMode = tP.FLIPBOOK_SINGLE_PAGE_MODE.AUTO)),
          void 0 !== e.controlsPosition &&
            "hide" === e.controlsPosition &&
            (e.controlsPosition = tP.CONTROLS_POSITION.HIDDEN),
          void 0 !== e.overwritePDFOutline &&
            (e.overwritePDFOutline = l.isTrue(e.overwritePDFOutline)),
          void 0 !== e.webgl && ((e.is3D = e.webgl = e.webgl), delete e.webgl),
          void 0 !== e.webglShadow &&
            ((e.has3DShadow = l.isTrue(e.webglShadow)), delete e.webglShadow),
          void 0 !== e.scrollWheel &&
            (l.isTrue(e.scrollWheel) &&
              (e.mouseScrollAction = tP.MOUSE_SCROLL_ACTIONS.ZOOM),
            delete e.scrollWheel),
          void 0 !== e.stiffness && delete e.stiffness,
          void 0 !== e.soundEnable &&
            ((e.enableSound = l.isTrue(e.soundEnable)), delete e.soundEnable),
          void 0 !== e.enableDownload &&
            ((e.showDownloadControl = l.isTrue(e.enableDownload)),
            delete e.enableDownload),
          void 0 !== e.autoEnableOutline &&
            ((e.autoOpenOutline = l.isTrue(e.autoEnableOutline)),
            delete e.autoEnableOutline),
          void 0 !== e.autoEnableThumbnail &&
            ((e.autoOpenThumbnail = l.isTrue(e.autoEnableThumbnail)),
            delete e.autoEnableThumbnail),
          void 0 !== e.direction &&
            ("2" === e.direction ||
            2 === e.direction ||
            e.direction === tP.READ_DIRECTION.RTL
              ? (e.readDirection = tP.READ_DIRECTION.RTL)
              : (e.readDirection = tP.READ_DIRECTION.LTR),
            delete e.direction),
          void 0 !== e.hard &&
          ...
          if (!0 !== e.linksparsed) {
            ...
            try {
              for (var o in e.links) {
                for (
                  var a = e.links[o], s = [100, 100], r = 0;
                  r < a.length;
                  r++
                ) {
                  for (
                    var h = a[r].substr(1).slice(0, -1).split(","),
                      u = [],
                      p = 0;
                    p < 5;
                    p++
        ...
        tw(document).ready(function () {
          ...
          tP.executeCallback("beforeDearFlipInit"),
            void 0 !== window.dFlipWPGlobal &&
              tw.extend(!0, tP.defaults, tS(window.dFlipWPGlobal)),
            tP.initUtils(),
            tP.initControls(),
            e.on(
              "click",
              ...
              function (e) {
                ...
                "#" === n || void 0 === n || t.hasClass("df-hash-focused")
                  ...
                  : "_self" === i ||
                    "_blank" === i ||
                    (void 0 == i && "_self" === tP.defaults.targetWindow
                      ? t.attr("target", "_self")
                      : void 0 == i && "_blank" === tP.defaults.targetWindow
